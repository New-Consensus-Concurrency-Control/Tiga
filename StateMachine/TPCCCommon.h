...
#define TPCC_VAR_C_YTD_PAYMENT (1054)
#define TPCC_VAR_C_DATA (1055)
#define TPCC_VAR_THRESHOLD (1060)
#define TPCC_VAR_UNKOWN (1061)
#define TPCC_VAR_C_DELIVERY_CNT (1062)
#define TPCC_VAR_N_PIECE_ALL (1080)
#define TPCC_VAR_PIECE_WAREHOUSE (1071)
#define TPCC_VAR_PIECE_DISTRICT (1072)
#define TPCC_VAR_S_QUANTITY (1073)
#define TPCC_VAR_S_YTD (1074)
#define TPCC_VAR_S_ORDER_COUNT (1075)
#define TPCC_VAR_S_REMOTE_COUNT (1076)
#define TPCC_ORDER_ROW (2001)       // lock the whole table
#define TPCC_ORDER_LINE_ROW (2002)  // lock the whole table
#define TPCC_NEW_ORDER_ROW (2003)   // lock the whole table
#define TPCC_HISTORY_ROW (2004)     // lock the whole table

#define TPCC_VAR_C_LAST_VERSION (3004)
#define ABORT_FLAG (5005000)

#define TPCC_VAR_I_ID(I) (100000 + I)
#define IS_I_ID(I) (I >= 100000 && I < 101000)
#define I_ID_POS(I) (I - 100000)
...
#define IS_S_W_ID(I) (I >= 106000 && I < 107000)
#define S_W_ID_POS(I) (I - 106000)
#define TPCC_VAR_S_D_ID(I) (107000 + I)
#define TPCC_VAR_OL_QUANTITY(I) (108000 + I)
#define OL_ID_POS(I) (I - 108000)
...
#define TPCC_VAR_AT_S_QUANTITY(I) (117000 + I)
#define TPCC_VAR_AT_OL_AMOUNT(I) (118000 + I)
#define TPCC_VAR_STOCK_QUANTITY(I) (119000 + I)
...
#define TPCC_TB_WAREHOUSE "warehouse"
#define TPCC_TB_DISTRICT "district"
#define TPCC_TB_CUSTOMER "customer"
#define TPCC_TB_HISTORY "history"
#define TPCC_TB_ORDER "order"
#define TPCC_TB_NEW_ORDER "new_order"
#define TPCC_TB_ITEM "item"
#define TPCC_TB_STOCK "stock"
#define TPCC_TB_ORDER_LINE "order_line"
#define TPCC_TB_ORDER_C_ID_SECONDARY "order_secondary"
